  ...
  <div class="info">
    ...
    <div class="display">
      ...
      {:else if $filter.type == "character"}
        <img src="https://fastly.jsdelivr.net/gh/sunshineplan/uma-musume@gh-pages/image/{$filter.image}" alt={$filter.name} />
          ...
          <li>
            <img
              class:selected={$filter.type == "character" &&
                $filter.name == i.name}
              src="https://fastly.jsdelivr.net/gh/sunshineplan/uma-musume@gh-pages/image/{i.image}"
              alt={i.name}
              title={i.name}
              style="height:72px"
              on:click={() => {
